...
mongoose.connect('mongodb+srv://pranshul4782:pogar@cluster1.yfrh43g.mongodb.net/mydb', {useNewUrlParser: true, useUnifiedTopology: true });
...
app.post('/send-command', (req, res) => {
    ...
    const topic = `/2110994782/command/${deviceId}`;
